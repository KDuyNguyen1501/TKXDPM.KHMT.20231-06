...
public class Configs {
	...
	public static final String INVOICE_SCREEN_PATH = "/group06/views/fxml/invoice.fxml";
	public static final String INVOICE_MEDIA_SCREEN_PATH = "/group06/views/fxml/media_invoice.fxml";
	public static final String PAYMENT_SCREEN_PATH = "/group06/views/fxml/payment.fxml";
	public static final String RESULT_SCREEN_PATH = "/group06/views/fxml/result.fxml";
	public static final String SPLASH_SCREEN_PATH = "/group06/views/fxml/splash.fxml";
	public static final String CART_SCREEN_PATH = "/group06/views/fxml/cart.fxml";
	public static final String SHIPPING_SCREEN_PATH = "/group06/views/fxml/shipping.fxml";
	public static final String CART_MEDIA_PATH = "/group06/views/fxml/media_cart.fxml";
	public static final String HOME_PATH  = "/group06/views/fxml/home.fxml";
	public static final String HOME_MEDIA_PATH = "/group06/views/fxml/media_home.fxml";
	public static final String POPUP_PATH = "/group06/views/fxml/popup.fxml";
